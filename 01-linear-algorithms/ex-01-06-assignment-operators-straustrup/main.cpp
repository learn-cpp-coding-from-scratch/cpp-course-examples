...
// using namespace std; НЕ РЕКОМЕНДУЕТСЯ
using std::cout;
using std::cin;
using std::endl;
using std::string;
...
int main() {
    ...
    // https://ru.cppreference.com/w/cpp/language/initialization
    // Инициализация переменной устанавливает её начальное значение во время конструирования.
   
    // виды инициализации
    int a1 = 5; // Инициализация копированием
    int a2(5); // Прямая инициализация
    int a3{5}; // Инициализация значения
    int a4 = { 5 }; // Агрегированная инициализация
    int a5; // инициализация по умолчанию - в данном случае ничем не инициализируется - там "мусор"
