...
- Один файл в корне CMakeLists.txt, и собственные файлы в каждос=м проекте.
...
- Корневой CMakeLists.txt в каждом приложении - подключение subdirectories (add_subdirectory).
